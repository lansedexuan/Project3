...
public class LLMTest {
    ...
    public void testGPTDemo() {
        //初始化模型
        OpenAiChatModel model = OpenAiChatModel.builder()//LangChain4j提供的代理服务器，该代理服务器会将演示密钥替换成真实密钥， 再将请求转 发给OpenAI API
    ...
    public void testSpringBoot() {
        String answer = openAiChatModel.chat("今天几号");
        System.out.println(answer);
    }

    @Autowired
    @Qualifier("qwenChatModel")   // 指定用 DashScope 的那个
