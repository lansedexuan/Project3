...
public class ChatMemoryTest {
    ...
    public void testChatMemory3() {
        //.withMaxMessages(10)：设置缓存的聊天记录数量为10
    ...
    public void testChatMemory4() {
        String answer1 = memoryChatAssistant.chat("我是李四");
        System.out.println(answer1);
    ...
    public void testChatMemory5() {
        String answer1 = separateChatAssistant.chat(1,"我是李四");//用户1
        System.out.println(answer1);
        String answer2 = separateChatAssistant.chat(1,"我是谁");//用户1
        System.out.println(answer2);

        String answer3 = separateChatAssistant.chat(2,"我是王五");//用户2
        System.out.println(answer3);
        String answer4 = separateChatAssistant.chat(2,"我是谁");//用户2
